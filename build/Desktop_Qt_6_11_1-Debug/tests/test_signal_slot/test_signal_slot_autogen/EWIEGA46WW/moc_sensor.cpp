...
#include "../../../../../../tests/test_signal_slot/sensor.h"
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->tempChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Sensor::*)(int )>(_a, &Sensor::tempChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void Sensor::tempChanged(int _t1)
{
